""" Purpose: create a periodic tabe 
Authur: Spencer Ashiboye
"""
...
def make_periodic_table():
    """
    Creates and returns a compound dictionary containing the periodic table of elements.
    Each element is represented as a key-value pair where the key is the chemical symbol,
    and the value is a list containing the name and atomic mass.

    Returns:
        dict: The periodic table as a compound dictionary.
    """
    periodic_table_dict = {
        "Ac": ["Actinium", 227],
        "Ag": ["Silver", 107.8682],
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    Parameters
        symbol_quantity_list: List of [symbol, quantity] pairs.
        periodic_table_dict: Dictionary of elements with
            their names and atomic masses.
...
def main():
    ...
    # Generate the periodic table and parse the formula
